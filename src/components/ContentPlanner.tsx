  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 text-slate-200">
      ...
      <div className="xl:col-span-5 bg-slate-800/40 border border-slate-800 rounded-2xl p-5 flex flex-col text-left bento-glow-indigo">
        ...
        <div className="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 xl:grid-cols-5 gap-1.5 mb-4 max-h-[140px] overflow-y-auto pr-1 scrollbar-narrow">
          {Array.from({ length: 30 }).map((_, id) => {
            ...
            return (
              <button 
                ...
                className={`p-1.5 text-center rounded text-xs font-mono font-bold transition cursor-pointer flex flex-col items-center justify-center ${
                  isSelected 
        ...
        <div className="bg-slate-800/20 p-4 rounded-xl border border-slate-800 flex-1 flex flex-col justify-between min-h-[280px]">
          <div>
      ...
      <div className="xl:col-span-7 bg-slate-800/40 border border-slate-800 rounded-2xl p-5 flex flex-col text-left bento-glow-indigo">
        ...
        {/* Output area */}
        <div className="flex-1 bg-slate-800/20 rounded-xl border border-slate-800 p-4 min-h-[350px] flex flex-col justify-between">
          {analysisReport ? (
            <div className="space-y-4 pr-1 max-h-[360px] overflow-y-auto scrollbar-narrow text-left">
              ...
              <p className="text-xs text-slate-200 font-mono bg-black/35 p-2.5 border border-slate-900 rounded italic leading-relaxed pl-3 font-semibold">
                "{analysisReport.extractedScript}"
              </p>
              ...
              <div className="flex gap-2 pt-2">
                <button 
                  ...
                  className="flex-1 py-1.5 bg-emerald-500 hover:bg-emerald-600 font-bold text-black text-xs rounded transition flex items-center justify-center gap-1.5 cursor-pointer"
                >
